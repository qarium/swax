---
title: Commands
description: CLI surface — init, discover, plan, the global --env-file option, and exit codes.
---

# Commands

Swax exposes three subcommands on the `swax` Click group. All commands share
